...
CREATE TABLE `cers_information` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户高考信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cers_information` VALUES (3,1,2,1,588),(4,102,2,0,630);
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='行为记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=258 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',0,1,'0','0','admin','2024-02-28 22:41:32','admin','2025-03-13 16:44:28','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (101,2042),(101,2043),(101,2045),(101,2046),(101,2049),(101,2058),(101,2062),(101,2063),(101,2065),(101,2066);
...
-- Dump completed on 2025-03-14 11:21:18
