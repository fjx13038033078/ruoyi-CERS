...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='问题反馈表';
...
INSERT INTO `cers_feedback` VALUES (7,1,'希望信息尽快完善',1,'收到','2025-02-20 16:14:36');
...
CREATE TABLE `cers_province` (
  ...
  `min_score_liberal` int DEFAULT NULL COMMENT '2024年文科最低投档线',
  `min_score_science` int DEFAULT NULL COMMENT '2024年理科最低投档线',
  PRIMARY KEY (`province_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='地图展示信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cers_province` VALUES (2,'山西',21,0,1,567,545),(3,'北京',88,6,13,530,531);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='行为记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cers_storeup` VALUES (1,1,1,2,'2025-02-21 15:01:00'),(2,1,1,2,'2025-02-21 15:01:09'),(3,1,1,2,'2025-02-21 15:01:16'),(4,1,1,1,'2025-02-21 15:07:04'),(5,100,1,2,'2025-02-21 16:48:20'),(6,100,5,2,'2025-02-21 16:48:24'),(7,100,7,1,'2025-02-21 16:48:32'),(8,100,10,2,'2025-02-21 16:48:36'),(9,100,15,2,'2025-02-21 16:48:41'),(10,101,1,2,'2025-02-21 16:49:15'),(11,101,7,2,'2025-02-21 16:49:20'),(12,101,10,1,'2025-02-21 16:49:23'),(13,101,15,2,'2025-02-21 16:49:27');
...
INSERT INTO `sys_config` VALUES (1,'主框架页-默认皮肤样式名称','sys.index.skinName','skin-blue','Y','admin','2024-02-28 22:23:43','',NULL,'蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow'),(2,'用户管理-账号初始密码','sys.user.initPassword','123456','Y','admin','2024-02-28 22:23:43','',NULL,'初始化密码 123456'),(3,'主框架页-侧边栏主题','sys.index.sideTheme','theme-dark','Y','admin','2024-02-28 22:23:43','',NULL,'深色主题theme-dark，浅色主题theme-light'),(4,'账号自助-验证码开关','sys.account.captchaEnabled','true','Y','admin','2024-02-28 22:23:43','',NULL,'是否开启验证码功能（true开启，false关闭）'),(5,'账号自助-是否开启用户注册功能','sys.account.registerUser','false','Y','admin','2024-02-28 22:23:43','',NULL,'是否开启注册用户功能（true开启，false关闭）'),(6,'用户登录-黑名单列表','sys.login.blackIPList','','Y','admin','2024-02-28 22:23:43','',NULL,'设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
...
) ENGINE=InnoDB AUTO_INCREMENT=203 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2065 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=252 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-03-10 11:34:44','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',0,1,'0','0','admin','2024-02-28 22:41:32','admin','2025-02-21 16:46:57','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (101,2042),(101,2043),(101,2046),(101,2049),(101,2058),(101,2062),(101,2063);
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2025-02-21 17:15:10','admin','2024-02-28 22:23:42','','2025-02-21 17:15:09','管理员',333.20),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员',NULL),(100,100,'zhangsan','张三','00','','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','0','127.0.0.1','2025-02-21 16:47:22','admin','2024-03-04 18:58:34','admin','2025-02-21 16:47:21',NULL,10.00),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','0','127.0.0.1','2025-02-21 16:49:06','admin','2024-03-04 18:58:57','admin','2025-02-21 16:49:05',NULL,10.00),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','127.0.0.1','2024-03-10 11:35:34','admin','2024-03-04 18:59:22','admin','2025-01-16 17:10:32',NULL,9666.80),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','127.0.0.1','2024-03-06 15:38:23','admin','2024-03-04 18:59:55','admin','2024-03-08 10:19:42',NULL,10000.00);
...
-- Dump completed on 2025-02-21 17:24:21
